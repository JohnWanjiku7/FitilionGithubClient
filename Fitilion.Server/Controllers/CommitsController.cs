...
namespace Fitilion.Server.Controllers
{
    ...
    public class CommitsController : ControllerBase
    {
        ...
        {
            var result = await _gitHubCommitsService.SaveGitHubCommit(commitId, repoName, repoOwner);
            return (result);
        }
        ...
        {
            var result = await _gitHubCommitsService.RemoveGitHubCommit(commitId, repoName, repoOwner);
            return (result);
        }
        ...
        {
            var result = await _gitHubCommitsService.SearchGitHubCommit(repoName, repoOwner, message);
            return Ok(result);
        }
        ...
        {
            var result = await _gitHubCommitsService.GetSavedCommits();
            return Ok(result);
        }
        ...
        {
            var result = await _gitHubCommitsService.SearchSavedCommits(searchQuery);
            return Ok(result);
        }
    }
}
